...
public class MinimapSelfMarkerGuiLayer implements GuiLayer {
    ...
    private static void renderPlayerMarker(Minecraft minecraft, GuiGraphicsExtractor graphics,
        ...
        if (northLocked) {
            ...
            if (u == null) { graphics.fill(cx-2, cy-2, cx+3, cy+3, PLAYER_COLOR); return; }
            graphics.submitGuiElementRenderState(new ArrowMarkerRenderState(graphics.pose(),
